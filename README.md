...
2. **Install required libraries**:
   ...
   NOT RECOMMEND:
   ```bash
   npm install colors axios bs58check blakejs @stablelib/ed25519 https-proxy-agent socks-proxy-agent @mavrykdynamics/taquito @mavrykdynamics/taquito-signer --no-fund --no-audit --legacy-peer-deps --force
   ```
